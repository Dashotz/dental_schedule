    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="{{ route('doctor.login') }}" class="hidden md:flex items-center gap-2 bg-dental-teal hover:bg-dental-teal-dark text-white font-semibold py-2 px-4 rounded-lg transition-colors">
        ...
        <div class="hidden md:hidden pb-4 border-t border-gray-200" id="mobileMenu">
            <div class="flex flex-col gap-2 pt-4">
                ...
                <a href="{{ route('doctor.login') }}" class="flex items-center justify-center gap-2 bg-dental-teal hover:bg-dental-teal-dark text-white font-semibold py-2 px-4 rounded-lg transition-colors mt-2">
                    <x-dental-icon name="box-arrow-in-right" class="w-5 h-5" />
                    <span>Doctor Login</span>
                </a>
            </div>
