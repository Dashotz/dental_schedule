...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Welcome back, {{ auth('admin')->user()->name }}!</p>
    </div>
                                ...
                                @foreach($recentSubdomains as $subdomain)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2 py-1 rounded text-xs font-medium {{ $subdomain->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                        ...
                        @foreach($expiringSoon as $subdomain)
                            <div class="p-4 border border-gray-200 rounded-lg">
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('admin.subdomains.edit', $subdomain) }}"
                                        class="inline-flex items-center gap-2 btn-dental-outline text-sm py-1.5 px-3">
