            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0"><?php echo e($todayAppointmentsCount); ?></h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0"><?php echo e($pendingAppointments); ?></h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0"><?php echo e($totalAppointments); ?></h3>
                    </div>
                            ...
                            <a href="<?php echo e(route('appointments.show', $appointment)); ?>" 
                               class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1"><?php echo e($appointment->patient->first_name); ?> <?php echo e($appointment->patient->last_name); ?></h6>
                                    <small class="badge bg-<?php echo e($appointment->status === 'completed' ? 'success' : ($appointment->status === 'cancelled' ? 'danger' : 'primary')); ?>">
                                ...
                                <p class="mb-1">
                                    ...
                                    <span class="text-muted">• <?php echo e(ucfirst($appointment->type)); ?></span>
                                </p>
                            </a>
                        ...
                        <?php $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('appointments.show', $appointment)); ?>" 
                               class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1"><?php echo e($appointment->patient->first_name); ?> <?php echo e($appointment->patient->last_name); ?></h6>
                                    <small class="text-muted"><?php echo e($appointment->appointment_date->format('M d')); ?></small>
                                </div>
                                <p class="mb-1">
                                    <i class="bi bi-clock"></i> <?php echo e($appointment->appointment_date->format('g:i A')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Github\dental_schedule\resources\views/dashboard.blade.php ENDPATH**/ ?>