                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-bottom">
                            <td class="ps-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <small class="text-muted"><?php echo e($subscription->subdomain->subdomain); ?>.yourdomain.com</small>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                <strong class="text-success">$<?php echo e(number_format($subscription->amount, 2)); ?></strong>
                            </td>
                            ...
                            <td>
                                ...
                                <span class="<?php echo e($subscription->end_date->isPast() ? 'text-danger' : ''); ?>">
                                    <?php echo e($subscription->end_date->format('M d, Y')); ?>

                                </span>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-<?php echo e($subscription->status === 'active' ? 'success' : ($subscription->status === 'expired' ? 'danger' : 'warning')); ?> px-3 py-2">
                                    <i class="bi bi-<?php echo e($subscription->status === 'active' ? 'check-circle' : ($subscription->status === 'expired' ? 'x-circle' : 'clock')); ?>"></i>
...
<!-- Modals -->
<?php echo $__env->make('admin.subscriptions.modals.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
