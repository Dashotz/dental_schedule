        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="viewSubdomainModalLabel">
                    <i class="bi bi-globe me-2"></i><?php echo e($subdomain->name); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            ...
                            <strong class="d-block"><?php echo e($subdomain->subdomain); ?>.yourdomain.com</strong>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            ...
                            <strong class="d-block"><?php echo e($subdomain->name); ?></strong>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                    ...
                    <div class="col-12">
                        <div class="p-3 bg-light rounded">
                            ...
                            <span class="d-block"><?php echo e($subdomain->address); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="col-12">
                        <div class="p-3 bg-light rounded">
                            ...
                            <span class="d-block"><?php echo e($subdomain->description); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <button class="btn btn-primary w-100 mb-2" id="generateLinkBtnModal" data-subdomain-id="<?php echo e($subdomain->id); ?>">
                                    <i class="bi bi-link-45deg"></i> Generate Registration Link
                                </button>
                                <button class="btn btn-warning w-100" id="editSubdomainBtnModal" data-subdomain-id="<?php echo e($subdomain->id); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <small class="text-muted d-block">
                                                ...
                                                Uses: <strong><?php echo e($activeLink->used_count); ?></strong>/∞ (Unlimited)
                                            </small>
                                            <?php if($activeLink->expires_at): ?>
                                                <small class="text-muted d-block mt-1">
                                                    <i class="bi bi-calendar-x"></i> 
                                                    Expires: <strong><?php echo e($activeLink->expires_at->format('M d, Y')); ?></strong>
...
<?php /**PATH H:\Github\dental_schedule\resources\views/admin/subdomains/modals/show.blade.php ENDPATH**/ ?>