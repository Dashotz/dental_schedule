...
<g class="<?php echo e($classes); ?>" data-tooth="<?php echo e($toothNumber); ?>" transform="translate(<?php echo e($x); ?>, <?php echo e($y); ?>)" style="cursor: pointer;">
    ...
    <?php if($isMolar): ?>
        ...
        <path d="M 0,0 Q 5,0 10,5 L 10,20 Q 10,25 5,25 L 5,25 Q 0,25 0,20 Z" 
              ...
              stroke-width="1.5"
              opacity="<?php echo e(($condition === 'extracted' || $condition === 'missing') ? '0.7' : '1'); ?>"/>
        <path d="M 10,5 Q 15,5 20,10 L 20,20 Q 20,25 15,25 L 10,25 Q 10,25 10,20 Z" 
              fill="<?php echo e($fillColor); ?>" 
              stroke="<?php echo e($strokeColor); ?>" 
              stroke-width="1.5"
              opacity="<?php echo e(($condition === 'extracted' || $condition === 'missing') ? '0.7' : '1'); ?>"/>
    <?php elseif($isIncisor): ?>
    ...
    <text x="12" y="18" text-anchor="middle" dominant-baseline="central" 
          ...
          fill="<?php echo e(($condition === 'extracted' || $condition === 'missing') ? '#ffffff' : '#333333'); ?>">
        <?php echo e($toothNumber); ?>
...
<?php /**PATH H:\Github\dental_schedule\resources\views/patient/partials/tooth-svg.blade.php ENDPATH**/ ?>